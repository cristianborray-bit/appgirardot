...
- El proyecto Supabase de esta app es `appgirardot` (id `umqotxoixboqkgerlupy`, us-east-1). NO tocar los proyectos `Zumas` ni `cristianborray-bit's Project` de la misma cuenta.
