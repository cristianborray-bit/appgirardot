...
- [ ] Confirmar en Meta Events Manager (pestaña "Probar eventos" o "Diagnóstico") que llegan los eventos `PageView` (al abrir el sitio, ya se puede probar ahora) y `Lead` (al enviar el formulario de contacto de prueba)
