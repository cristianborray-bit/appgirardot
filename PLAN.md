...
## FASE 7 — Rediseño visual "Arena" `[estado: 🔄 en curso — R0+R1+R2 completas; R3 auditada y verificada, esperando OK final para desplegar a producción]`
...
- [~] **R3 · Cierre (auditado y verificado; falta solo el despliegue a producción, gated por Cristian):** auditoría completa con las 3 skills del gate de cierre:
  ...
  - **Pendiente:** link de vista previa de Vercel para que Cristian revise desde el celular, y **despliegue a producción SOLO con su visto bueno final**
...
**Pendiente de Cristian:** revisar el link de vista previa y dar el OK final para desplegar a producción (`aqualinagirardot.company`)
