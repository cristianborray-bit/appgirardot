...
- [ ] Crear el píxel de "Aqualina Orange" en Meta Events Manager (uno nuevo, NO el "BotrayIA Pixel" que es de otro negocio) y darme el ID numérico, o ponerlo directo en Vercel como `NEXT_PUBLIC_META_PIXEL_ID`
