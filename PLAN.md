...
- [ ] Confirmar también el evento `Lead`: llenar el formulario "Que Cristian me contacte" de prueba en el sitio y revisar que aparezca en esa misma pestaña
- [ ] Confirmar que `aqualinagirardot.company` ya se ve con el diseño nuevo "Arena" (si se ve igual que antes, recargar con Ctrl+Shift+R o abrir desde datos móviles, por si el navegador guardó la versión vieja)
